...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1452960092;
...
abstract class RustLibApi extends BaseApi {
  String crateApiSimpleTreinarRedePerceptron(
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  String crateApiSimpleTreinarRedePerceptron(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiSimpleTreinarRedePerceptronConstMeta,
      argValues: [vetorMatriz1, vetorMatriz2, vetorTeste],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiSimpleTreinarRedePerceptronConstMeta =>
      const TaskConstMeta(
        debugName: "treinar_rede_perceptron",
